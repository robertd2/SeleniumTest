...
//	}
	...
	public void invalidLoginTest() throws Exception {
		...
		assertEquals("Expected error message: Authentication failed. It was: " + driver.findElement(errorMsg).getText(),
				"Authentication failed.", driver.findElement(errorMsg).getText());

		mainPage.logIn(new User("k782713@mvrht.com", "1234"));
		assertEquals("Expected error message: Invalid password. It was: " + driver.findElement(errorMsg).getText(),
				"Invalid password.", driver.findElement(errorMsg).getText());
